    ...
    <div className="container mx-auto max-w-4xl px-4 py-12 md:py-20">
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
            ...
            <p>Bienvenido a nuestra tienda. Estos términos y condiciones describen las reglas y regulaciones para el uso de nuestro sitio web y los servicios que ofrecemos. Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando este sitio si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.</p>
            ...
            <p>El Servicio y su contenido original, características y funcionalidad son y seguirán siendo propiedad exclusiva de nuestra tienda y sus licenciantes. El Servicio está protegido por derechos de autor, marcas registradas y otras leyes tanto de Perú como de países extranjeros.</p>
